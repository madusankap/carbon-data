...
<fmt:bundle basename="org.wso2.carbon.dataservices.ui.i18n.Resources">
    ...
    <tr>
        ...
        %>
        <td>
            <span style="margin-left: 3px"> <input id="apiCheckBox" type="checkbox" checked
                                                   onclick="changeState();return"> <fmt:message key="api.available"/></span>
        </td>
        <%
        } else {
        %>
        <td>
            <span style="margin-left: 3px"> <input id="apiCheckBox" type="checkbox"
                                                   onclick="changeState();return">  <fmt:message key="api.unavailable"/></span>
        </td>
        <%
            }
        %>
