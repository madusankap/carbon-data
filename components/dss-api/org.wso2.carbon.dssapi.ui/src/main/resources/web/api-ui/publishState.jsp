...
<fmt:bundle basename="org.wso2.carbon.dssapi.ui.i18n.Resources">
    <table class="styledLeft" id="apiOperationsTable" style="margin-left: 0px;" width="100%">
        ...
        <tr>
            ...
            %>
            <td style="background:url(./images/deactivate.gif) no-repeat left center"> &nbsp;&nbsp;&nbsp;API is not Available [ <a href="#" onclick="changeState(true);return false;" >Publish an API</a> ]
            </td>
            <%
                }
            %>
