...
public class APIPublisherClient {
    APIPublisherStub apiPublisherStub;
    ...
    public static void main(String[] args) {
        APIPublisherClient apiPublisherClient = new APIPublisherClient();
        try {
            System.out.println(apiPublisherClient.getNumberOfPages());
        } catch (RemoteException e) {
            e.printStackTrace();
        } catch (APIPublisherException e) {
            e.printStackTrace();
        }
    }
